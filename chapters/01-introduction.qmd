...
- [Conversation, Not Delegation: Mastering Human-AI Development](https://michaelborck-books.github.io/intentional-prompting) (this book)

**Python Track**

- [Think Python, Direct AI: Computational Thinking for Beginners](https://michaelborck-books.github.io/python-step-by-step-ai) - Perfect for absolute beginners
- [Code Python, Consult AI: Python Fundamentals for the AI Era](https://michaelborck-books.github.io/python-foundations) - Core Python knowledge
...
- [Build Web, Guide AI: Business Web Development with AI](https://michaelborck-books.github.io/web-dev-step-by-step-ai) - HTML, CSS, JavaScript, WordPress, React
